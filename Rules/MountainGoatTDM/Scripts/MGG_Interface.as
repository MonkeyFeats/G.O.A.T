...
void onInit(CRules@ this)
{
	...
	this.set_CBitStream("mgg_serialised_team_hud", stream);
}
...
void onRender(CRules@ this)
{
	...
	this.get_CBitStream("mgg_serialised_team_hud", serialised_team_hud);
	...
	if (serialised_team_hud.getBytesUsed() > 10)
	{
		...
		if (serialised_team_hud.saferead_u16(check) && check == 0x5afe)
		{
			...
			{
				MGG_HUD hud(serialised_team_hud);
	...
	string propname = "mgg spawn time " + p.getUsername();
